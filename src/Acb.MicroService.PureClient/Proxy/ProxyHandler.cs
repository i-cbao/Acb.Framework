...
namespace Acb.MicroService.PureClient.Proxy
{
    ...
    internal static class AsyncDispatchProxyGenerator
    {
        ...
        private static readonly MethodInfo s_dispatchProxyInvokeMethod = typeof(ProxyAsync).GetTypeInfo().GetDeclaredMethod("Invoke");
        private static readonly MethodInfo s_dispatchProxyInvokeAsyncMethod = typeof(ProxyAsync).GetTypeInfo().GetDeclaredMethod("InvokeAsync");
        private static readonly MethodInfo s_dispatchProxyInvokeAsyncTMethod = typeof(ProxyAsync).GetTypeInfo().GetDeclaredMethod("InvokeAsyncT");
        ...
        private class PackedArgs
        {
            ...
            internal ProxyAsync DispatchProxy { get { return (ProxyAsync)_args[DispatchProxyPosition]; } }
        ...
        {
            private static readonly MethodInfo s_delegateInvoke = typeof(ProxyHandler).GetMethod("InvokeHandle");
            private static readonly MethodInfo s_delegateInvokeAsync = typeof(ProxyHandler).GetMethod("InvokeAsyncHandle");
            private static readonly MethodInfo s_delegateinvokeAsyncT = typeof(ProxyHandler).GetMethod("InvokeAsyncHandleT");
            ...
            private MethodBuilder AddMethodImpl(MethodInfo mi)
            {
                ...
                il.Emit(OpCodes.Ldarg_0);
                packedArr.EndSet(typeof(ProxyAsync));
