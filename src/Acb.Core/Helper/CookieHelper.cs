...
namespace Acb.Core.Helper
{
    ...
    public static class CookieHelper
    {
        ...
        {
            if (AcbHttpContext.Current == null) return;
            var key = cookieName;
            ...
            AcbHttpContext.Current.Response.Cookies.Append(key, value, options);
        }
        ...
        {
            if (!AcbHttpContext.Current.Request.Cookies.TryGetValue(cookieName, out var cookie))
                return string.Empty;
