...
namespace Acb.ProxyGenerator.Utils
{
    public static class ReflectionUtils
    {
        ...
        public static bool IsNonProxy(this TypeInfo typeInfo)
        {
            if (typeInfo == null)
            {
                throw new ArgumentNullException(nameof(typeInfo));
            }
            return typeInfo.GetReflector().IsDefined(typeof(NonProxyAttribute));
        }

        public static bool IsNonProxy(this MethodInfo methodInfo)
        {
            if (methodInfo == null)
            {
                throw new ArgumentNullException(nameof(methodInfo));
            }
            return methodInfo.DeclaringType.GetTypeInfo().IsNonProxy() || methodInfo.GetReflector().IsDefined(typeof(NonProxyAttribute));
        }
