...
namespace Acb.Payment.Gateways.MicroPay
{
    ...
    public class Order : IDataOrder
    {
        ...
        /// </summary>
        public string TimeStart => Clock.Now.ToString("yyyyMMddHHmmss");
        ...
        [PaymentValidation(Enum.TradeType.Scan, ErrorMessage = "请设置商品ID")]
        ...
        /// 授权临时票据
        /// </summary>
        [PaymentValidation(new Enum.TradeType[] { Enum.TradeType.Public, Enum.TradeType.Applet }, ErrorMessage = "请设置用户标识")]
        ...
        [PaymentValidation(Enum.TradeType.Wap, ErrorMessage = "请设置场景信息")]
        ...
        [PaymentValidation(Enum.TradeType.Barcode, ErrorMessage = "请设置授权码")]
