...
{
    /// <summary> 支付宝辅助参数 </summary>
    public class DataAction : IDataAction
    {
        /// <summary>
        ...
        [PaymentValidation(ActionType.RefundQuery, ErrorMessage = "请设置退款请求号")]
        ...
        [PaymentValidation(ActionType.Refund, ErrorMessage = "请设置退款金额")]
        ...
        [PaymentValidation(ActionType.BillDownload, ErrorMessage = "请设置账单类型")]
        ...
        [PaymentValidation(ActionType.BillDownload, ErrorMessage = "请设置账单时间")]
        public string BillDate { get; set; }

        public bool Validate(ActionType actionType)
        {
